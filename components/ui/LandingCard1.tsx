...
interface LandingCard1Props {
    TopTitle: string;
    description: string;
    icon?: ReactElement;
}

const LandingCard1 = ({ TopTitle, description, icon }: LandingCard1Props) => {
    return (
        <StyledWrapper>
                ...
                <div className="canvas">
                    ...
                    <div id="card">
                        <div className="card-content">
                            ...
                            <div className='flex mt-5 justify-center text-white'>
                                <div>
                                    {icon}
                                </div>
                            </div>
                            <p id="prompt">{TopTitle}</p>
